...
function insertPosts() {
    ...
    articleCounter++;
    let postsMarkup = getPostMarkup(articleCounter);

    // 3.2 Перед scrollCheck вставьте записанную в postsMarkup разметку
    scrollCheck.innerHTML = scrollCheck.innerHTML + postsMarkup;
...
function getPostMarkup(counter) {
    ...
    плюс counter
    */
    let currendTime = new Date().getTime;
    let num = currendTime + " " + counter;
