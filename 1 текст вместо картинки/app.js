...
let buttonsEl = document.querySelectorAll(".productButton");
...
function hideMoreText(card) {
    ...
    card.productName.classList.remove(".desc");
...
function showMoreText(card) {
    ...
    let anyText = "Это произвольный текст";
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.classList.add(".desc");
    card.productName.innerText = anyText;
